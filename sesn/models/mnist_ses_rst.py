...
from .impl.ses_conv_rst import SESMaxProjection
from .impl.ses_conv_rst import SESConv_Z2_H, SESConv_H_H


class MNIST_SES_RST_Scalar(nn.Module):
...
class MNIST_SES_RST_V(nn.Module):
...
def mnist_ses_rst_scalar_28_rot_1(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
    ...
    model = MNIST_SES_RST_Scalar(pool_size=4, kernel_size=size, scales=scales, rotations=rotations,
                             basis_type=basis, mult=mult, max_order=4, dropout=dropout, spt=spt)
    return model

def mnist_ses_rst_scalar_28_rot_4(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_rst_vector_28_rot_4_interrot_2(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
    ...
    spt = 3.5
    basis = kwargs.get('basis', "E")
    model = MNIST_SES_RST_V(pool_size=4, kernel_size=size, scales=scales, rotations=rotations,
                        scale_size=1, rotation_size=2,
                        basis_type=basis, mult=mult, max_order=4, dropout=dropout)
    return model


def mnist_ses_rst_scalar_28_rot_8(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_rst_vector_28_rot_8_interrot_1(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_rst_vector_28_rot_8_interrot_4(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_rst_vector_28_rot_8_interrot_8(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_rst_scalar_56_rot_1(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
    ...
    spt = 3.5
    basis = kwargs.get('basis', "E")
    model = MNIST_SES_RST_Scalar(pool_size=8, kernel_size=size, scales=scales, rotations=rotations,
                             basis_type=basis, mult=mult, max_order=4, dropout=dropout, spt=spt)
    return nn.Sequential(nn.Upsample(scale_factor=2), model)

def mnist_ses_rst_scalar_56_rot_4(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_rst_vector_56_rot_4_interrot_2(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
    ...
    spt = 3.5
    basis = kwargs.get('basis', "E")
    model = MNIST_SES_RST_V(pool_size=8, kernel_size=size, scales=scales, rotations=rotations,
                        scale_size=1, rotation_size=2,
                        basis_type=basis, mult=mult, max_order=4, dropout=dropout)
    return nn.Sequential(nn.Upsample(scale_factor=2), model)

def mnist_ses_rst_vector_56_rot_4_interrot_4(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_rst_scalar_56_rot_8(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_rst_vector_56_rot_8_interrot_1(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_rst_vector_56_rot_8_interrot_4(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_rst_vector_56_rot_8_interrot_8(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
if __name__ == '__main__':
    ...
    net = mnist_ses_rst_vector_56_rot_8_interrot_8(basis="E")
    #DudeNeXt(3, num_of_layers=17)#Restormer()

    inp_shape = (3, 256//8, 256//8)
