...
from models_next_wt_1 import DudeNeXtWT_1
from models_next_1 import DudeNeXt_1
...
def main():
    ...
    #net = DudeNeXt_1(channels=1, num_of_layers=opt.num_of_layers)
    net = DudeNeXtWT_1(channels=1, num_of_layers=opt.num_of_layers)
...
if __name__ == "__main__":
    if opt.preprocess:
        if opt.mode == 'S':
            prepare_data(data_path='/home/bbb/data/denoi_gray', patch_size=41, stride=10, aug_times=4) #tcw201810102244
            #prepare_data(data_path='data', patch_size=50, stride=40, aug_times=1) #tcw201810102244
        if opt.mode == 'B':
            prepare_data(data_path='/home/bbb/data/denoi_gray', patch_size=41, stride=10, aug_times=4)
    main()
