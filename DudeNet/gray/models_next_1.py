...
class DudeNeXt_1(nn.Module):
    def __init__(self, channels=1, num_of_layers=15):
        super(DudeNeXt_1, self).__init__()
        kernel_size = 3
        padding = 1
        features = 64
        groups =1 
        ...
        self.conv1_2 = Bottleneck(features,features,dilation=2) 
        self.conv1_3 = Bottleneck(features,features) 
        self.conv1_4 = Bottleneck(features,features) 
        self.conv1_5 = Bottleneck(features,features,dilation=2) 
        self.conv1_6 = Bottleneck(features,features) 
        self.conv1_7 = Bottleneck(features,features) 
        self.conv1_8 = Bottleneck(features,features) 
        self.conv1_9 = Bottleneck(features,features,dilation=2) 
        self.conv1_10 = Bottleneck(features,features) 
        self.conv1_11 = Bottleneck(features,features) 
        self.conv1_12 = Bottleneck(features,features,dilation=2) 
        self.conv1_13 = Bottleneck(features,features) 
        self.conv1_14 = Bottleneck(features,features) 
        self.conv1_15 = Bottleneck(features,features) 
        self.conv1_16 = Bottleneck(features,features) 
        ...
        self.conv2_2 = Bottleneck(features,features) 
        self.conv2_3 = Bottleneck(features,features) 
        self.conv2_4 = Bottleneck(features,features) 
        self.conv2_5 = Bottleneck(features,features) 
        self.conv2_6 = Bottleneck(features,features) 
        self.conv2_7 = Bottleneck(features,features) 
        self.conv2_8 = Bottleneck(features,features) 
        self.conv2_9 = Bottleneck(features,features) 
        self.conv2_10 = Bottleneck(features,features) 
        self.conv2_11 = Bottleneck(features,features) 
        self.conv2_12 = Bottleneck(features,features) 
        self.conv2_13 = Bottleneck(features,features) 
        self.conv2_14 = Bottleneck(features,features) 
        self.conv2_15 = Bottleneck(features,features) 
