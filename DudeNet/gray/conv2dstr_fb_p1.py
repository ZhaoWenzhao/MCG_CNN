...
path_to_bessel = "/home/bbb/DudeNet/real_noisy/bessel.npy"#"./bessel.npy"
...
class Conv2dstr_fb_p1(nn.Module):
    """
    ...
    def __init__(self, 
        ...
        super(Conv2dstr_fb_p1, self).__init__()
        ...
        self.padding = padding+1*dilation
